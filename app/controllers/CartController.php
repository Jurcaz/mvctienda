...
class CartController extends Controller
{
    ...
    public function index($errors = [])
    {
        ...
        if ($session->getLogin()) {
            ...
            $this->view('carts/index', $dataView);
    ...
    public function checkout()
    {
        ...
        if ( $session->getLogin()) {
            ...
            $this->view('carts/address', $dataView);
            ...
            $this->view('carts/checkout', $dataView);
        }
    }
    ...
    public function paymentmode()
    {
        ...
        $this->view('carts/paymentmode', $dataView);
    }
    ...
    public function verify()
    {
        ...
        $this->view('carts/verify', $dataView);
    }
