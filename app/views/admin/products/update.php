...
<div class="card p-4 bg-light">
    ...
    <div class="card-body">
        <form action="<?= ROOT ?>adminproduct/update/<?= $dataView['product']->id ?>" method="POST" enctype="multipart/form-data">
            <div class="text-left">
                ...
                <select name="type" id="type" class="form-control">
                    ...
                    <?php foreach ($dataView['typeList'] as $type): ?>
                        <option value="<?= $type->value ?>"
                            <?= isset($dataView['product']->type) && $dataView['product']->type == $type->value ? 'selected' : '' ?>>
                            <?= $type->description ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group text-left mt-4">
                ...
                <textarea name="description" id="editor"><?= $dataView['product']->description ?? '' ?></textarea>
            </div>
            <div id="book">
                ...
                <div class="form-group text-left">
                    ...
                    <input type="text" name="publisher" id="publisher"
                           ...
                           value="<?= $dataView['product']->publisher ?? '' ?>">
                </div>
                <div class="form-group text-left">
            ...
            <div id="course">
                ...
                <div class="form-group text-left">
                    ...
                    <input type="text" name="objetives" id="objetives"
                           ...
                           value="<?= $dataView['product']->objetives ?? '' ?>">
                </div>
                <div class="form-group text-left">
                    ...
                    <input type="text" name="necesites" id="necesites"
                           class="form-control"
                           placeholder="Escribe el número de páginas del libro"
                           value="<?= $dataView['product']->necesites ?? '' ?>">
                </div>
            </div>
            <div class="form-group text-left">
            ...
            <div class="form-group text-left">
                ...
                <input type="text" name="discount" id="discount"
                       ...
                       value="<?= $dataView['product']->discount ?? '' ?>">
            </div>
            <div class="form-group text-left">
            ...
            <div class="form-group text-left">
                ...
                <input type="date" name="published" id="published"
                       ...
                       value="<?= $dataView['product']->published ?? '' ?>">
            </div>
            <div class="form-group text-left">
                ...
                <select name="relation1" id="relation1" class="form-control">
                    ...
                    <?php foreach ($dataView['catalogue'] as $item): ?>
                        <option value="<?= $item->id ?>"
                            <?= isset($dataView['product']->relation1) && $dataView['product']->relation1 == $item->id ? 'selected' : '' ?>>
                            <?= $item->name ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group text-left">
                ...
                <select name="relation2" id="relation2" class="form-control">
                    ...
                    <?php foreach ($dataView['catalogue'] as $item): ?>
                        <option value="<?= $item->id ?>"
                            <?= isset($dataView['product']->relation2) && $dataView['product']->relation2 == $item->id ? 'selected' : '' ?>>
                            <?= $item->name ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group text-left">
                ...
                <select name="relation3" id="relation3" class="form-control">
                    ...
                    <?php foreach ($dataView['catalogue'] as $item): ?>
                        <option value="<?= $item->id ?>"
                            <?= isset($dataView['product']->relation3) && $dataView['product']->relation3 == $item->id ? 'selected' : '' ?>>
                            <?= $item->name ?>
                        </option>
                    <?php endforeach; ?>
                </select>
                ...
                <select name="status" id="status" class="form-control">
                    ...
                    <?php foreach ($dataView['statusList'] as $status): ?>
                        <option value="<?= $status->value ?>"
                            <?= isset($dataView['product']->status) && $dataView['product']->status == $status->value ? 'selected' : '' ?>>
                            <?= $status->description ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-check text-left">
                <input type="checkbox" name="mostSold" id="mostSold"
                    <?= isset($dataView['product']->mostSold) && $dataView['product']->mostSold == '1' ? 'checked' : '' ?>
            ...
            <div class="form-check text-left">
                <input type="checkbox" name="new" id="new"
                    <?= isset($dataView['product']->new) && $dataView['product']->new == '1' ? 'checked' : '' ?>
                       class="form-check-input">
